...
async function aplicarFiltroUsuario(event) {
    try {
        ...
        // Guardar los valores actuales del filtro
        const filtroValores = {
        ...
        if (Array.isArray(personal)) {
            ...
            // Restaurar los valores del filtro
            $("#filtroOrden").val(filtroValores.orden);
            $("#filtroNombre").val(filtroValores.nombre);
            $("#filtroApellido").val(filtroValores.apellido);
            $("#filtroActivo").val(filtroValores.activo);
...
async function aplicarFiltroGrupo(event) {
    try {
        ...
        if (Array.isArray(grupos)) {
            ...
            $("#filtroOrden").val(filtroValores.orden);
            $("#filtroNombre").val(filtroValores.nombre);
            $("#filtroGrado").val(filtroValores.grado);
