                ...
                asignaturas.forEach(asignatura => {
                    asignaturasHtml += `
                        <tr>
                            ...
                            <td contenteditable="true">${asignatura.carga_horaria}</td>
        ...
        success: function(asignaturas) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    agregarAsignaturaATabla(nombreAsignatura, nombreGrupo, grado);
                }
            });
        },
        error: function() {
...
function agregarAsignaturaATabla(nombreAsignatura, nombreGrupo, grado) {
    let cargaHoraria = prompt("Ingrese la carga horaria para la asignatura:");
    cargaHoraria = parseInt(cargaHoraria); // Convertir a número
