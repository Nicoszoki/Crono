...
if (isset($_POST['nombre_G'], $_POST['grado'])) {
    ...
    $query = "SELECT T.nombre_A, T.carga_horaria, DI.ci AS docenteCI, CONCAT(P.nombre, ' ', P.apellido) AS docente, DI.dia, DI.hora
          FROM Tiene T
          ...
          WHERE T.nombre_G = ? AND T.grado = ? AND DI.hora != '0'
