...
<body>
    ...
    <div id="panel">
        <!-- columna -->
        <div id="columna">
            <div id="Horarios" class="opcion" onclick="horarios(); seleccion()">
                <label class="titulo">Horarios</label>
            </div>
            <div id="Asignaturas" class="opcion" onclick="asignaturas(); seleccion()">
                <label class="titulo">Asignaturas</label>
            </div>
            <div id="Grupos" class="opcion" onclick="grupos(); seleccion()">
                <label class="titulo">Grupos</label>
            </div>
            <div id="Usuarios" class="opcion" onclick="usuarios(); seleccion()">
